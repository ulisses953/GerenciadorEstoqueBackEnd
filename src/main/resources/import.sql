...
-- INSERT INTO tb_category (id, name, description) VALUES (12, 'Ferramentas', 'Ferramentas');
-- INSERT INTO tb_category (id, name, description) VALUES (13, 'Eletrônicos Domésticos', 'Eletrônicos para casa');
-- INSERT INTO tb_category (id, name, description) VALUES (14, 'Brinquedos', 'Brinquedos para todas as idades');
-- INSERT INTO tb_category (id, name, description) VALUES (15, 'Saúde e Bem-estar', 'Produtos relacionados à saúde e bem-estar');
-- INSERT INTO tb_category (id, name, description) VALUES (16, 'Arte e Artesanato', 'Materiais de arte e produtos artesanais');
-- INSERT INTO tb_category (id, name, description) VALUES (17, 'Instrumentos Musicais', 'Instrumentos e acessórios musicais');
-- INSERT INTO tb_category (id, name, description) VALUES (18, 'Automotivo', 'Produtos relacionados a automóveis');
-- INSERT INTO tb_category (id, name, description) VALUES (19, 'Eletrônicos para Fitness', 'Dispositivos eletrônicos voltados para atividades físicas');
-- INSERT INTO tb_category (id, name, description) VALUES (20, 'Viagem e Aventura', 'Produtos para viagens e aventuras');
